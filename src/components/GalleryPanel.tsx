...
export function GalleryPanel({
  ...
  const [activeFolder, setActiveFolder] = useState<string | null>(null); // null = all, "uncategorized" = no folder
      ...
      >
        ...
        <div className="w-56 border-l border-accent/30 flex flex-col shrink-0 bg-secondary/30">
          ...
          <div className="flex-1 overflow-auto p-1.5 space-y-0.5">
            ...
            <FolderItem
              name="ללא תיקיה"
              count={getFolderCount("uncategorized")}
          ...
          <div className="flex-1 overflow-auto p-4">
            {selectedId && selected ? (
              <div className="space-y-4">
                <Button variant="ghost" size="sm" onClick={() => setSelectedId(null)} className="text-foreground">
                  ← חזרה לגלריה
                </Button>
                ...
                <div className="flex gap-2 justify-center flex-wrap">
                  ...
                  <Button variant="outline" size="sm" onClick={() => copyToClipboard(selected)} className="border-accent text-foreground gap-1">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => setMovingScreenshotId(selected.id)}
                ...
                <AnimatePresence>
                  {movingScreenshotId === selected.id && (
                    ...
                    >
                      ...
                      <button
                        onClick={() => { onMoveToFolder(selected.id, null); setMovingScreenshotId(null); }}
                      ...
                      {folders.map((f) => (
                        <button
                          key={f.id}
                          onClick={() => { onMoveToFolder(selected.id, f.id); setMovingScreenshotId(null); }}
                          className={cn(
